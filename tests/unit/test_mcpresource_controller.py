...
from src.controllers.mcpresource_controller import delete_mcpresource, reconcile_mcpresource
...
class TestMCPResourceDeletion:
    """Tests for MCPResource deletion logic."""
